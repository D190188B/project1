        ...
        <div class="row m-0">
            <div class="col-lg-4 offset-lg-4">
                <div class="text-center pb-5">
                    <h1 class="login-title text-dark">Register As Therapist </h1>
                ...
                <div class="upload-profile-image d-flex justify-content-center pb-5">
                    <div class="text-center">
                        ...
                        <img src="images/profile/therapist.png" style="width: 200px; height: 200px" class="img rounded-circle" alt="profile">
                ...
                <div class="d-flex justify-content-center">
                    <form action="register.php" method="post" enctype="multipart/form-data" id="reg-form">
                        ...
                        <div class="form-row my-4">
                            <div class="col">
                            <h4>Gender</h4>
                                <input type="gender" required name="gender" id="gender" class="form-control">
                            </div>
                        </div>
                        <div class="form-row my-4">
                            <div class="col">
                        ...
                        <div class="form-row my-12">
                            ...
                            <h4>Education lvl</h4>
                            <div class="dropdown">
                            <select class="custom-select"  required name="education" id="education" class="form-control">
                                <a class="dropdown-item" href="#">M.Clin.Psych.</a>
                                  <a class="dropdown-item" href="#">M.A.Coun.Psych</a>
                                    <a class="dropdown-item" href="#">M.A.Counseling</a>
                                      <a class="dropdown-item" href="#">PhD</a>
                                       <a class="dropdown-item" href="#">PsyD</a>
                              </select>
                             </div>
                            </div>
                        </div>    
                ...
                <label class="custom-control-label" for="customRadioInline2">Malay</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="customRadioInline3" name="customRadioInline1" class="custom-control-input">
                <label class="custom-control-label" for="customRadioInline3">Chinese</label>
              </div>
            </div>
        </div>
                        ...
                        <div class="form-row my-4">
                            ...
                            <h4>License Number</h4>
                                <input type="license" required name="license" id="license" class="form-control">
                            </div>
                        </div>

                        <div class="form-check form-check-inline">
                            <input type="checkbox" name="agreement" class="form-check-input" required>
                            <label for="agreement" class="form-check-label font-ubuntu text-black-50">I accept the <a href="#">term, conditions, privacy policy  </a>and consent clause </label>
                        </div>
